...
<div class="page-wrapper">
  ...
  <main>
    ...
    <section class="lot-item container">
      <h2><?=$lotdata[0]['title'];?></h2>
      <div class="lot-item__content">
        <div class="lot-item__left">
          <div class="lot-item__image">
            <img src="<?=$lotdata[0]['image'];?>" width="730" height="548" alt="Сноуборд">
          </div>
          <p class="lot-item__category">Категория: <span><?=$lotdata[0]['catname'];?></span></p>
        ...
        <div class="lot-item__right">
          ...
          <div class="lot-item__state">
              ...
              <?php
              list($hour,$min)= get_exp_time($lotdata[0]['end_date']);
              ?>
            ...
            <div class="lot-item__cost-state">
              <div class="lot-item__rate">
                ...
                <span class="lot-item__cost"><?=$lotdata[0]['initial_price'];?></span>
              </div>
              <div class="lot-item__min-cost">
                Мин. ставка <span>12 000 р</span>
              </div>
            </div>
              <?php  if(!empty($errors)) {$classname ='form__item--invalid';} else {$classname ='';} ?>
            <form class="lot-item__form" action="/bet.php" method="post" autocomplete="off">
              <p class="lot-item__form-item form__item <?=$classname?>">
                <label for="cost">Ваша ставка</label>
                <input id="cost" type="text" name="cost" placeholder="12 000">
                  <input type="hidden" id="lotId" name="lotId" value="<?=$lot_id;?>">
          ...
          <div class="history">
            ...
            <table class="history__list">
                <?php foreach ($betdata as $data): ?>
              <tr class="history__item">
                <td class="history__name"><?=$data['name']?></td>
                <td class="history__price"><?=$data['amount']?>р</td>
                <td class="history__time">

                    <?php
                    list($hour,$min)= get_post_time($data['creation_time']);
                    ?>
                    <?=sprintf('%2d',$hour).'часа'." ".sprintf('%02d',$min).'минут назад';?>
