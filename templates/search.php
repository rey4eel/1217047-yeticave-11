      ...
      <section class="lots">
        ...
        <ul class="lots__list">
          ...
          <li class="lots__item lot">
            ...
            <div class="lot__info">
              <span class="lot__category"><?=$data['category']?></span>
              <h3 class="lot__title"><a class="text-link" href="<?='lot.php?id='.$data['id'] ?>"><?=$data['title']?></a></h3>
              <div class="lot__state">
                <div class="lot__rate">
                  <span class="lot__amount">Стартовая цена</span>
                  <span class="lot__cost"><?=$data['initial_price']?><b class="rub">р</b></span>
                </div>
                  <?php list($hour,$min)= get_exp_time($data['end_date']); ?>
